export default {
  ...
  'setting.knowledge.tip': 'PDF files are parsed into vectors, while metadata is stored locally.',
  'setting.knowledge.tip.description':
    'Only PDF uploads are supported. Removing a record only deletes local metadata and does not clean remote vectors.',
  ...
  'setting.knowledge.upload.select': 'Select PDF',
  'setting.knowledge.upload.submit': 'Upload Knowledge',
  'setting.knowledge.upload.selectFile': 'Please select a PDF file first',
  ...
  'setting.knowledge.delete.description': 'This only removes the local metadata record.',
