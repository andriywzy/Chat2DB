export default {
  ...
  'common.label.targetDatabase': 'Target database',
  'common.title.create': 'Create',
  'common.title.importRun': 'Import and run',
  ...
  'common.placeholder.searchDatabase': 'Search databases, instances, projects, or environments',
  'common.tips.importRun.emptyFile': 'The selected file is empty. Please choose a SQL file with content.',
  'common.tips.importRun.readFailed': 'Failed to read the SQL file.',
  'common.tips.importRun.databaseLoadFailed': 'Failed to load the database list. Please try again.',
};
