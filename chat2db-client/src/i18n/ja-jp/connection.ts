export default {
  ...
  'connection.label.group': 'グループ',
  'connection.label.project': 'プロジェクト',
  ...
  'connection.button.exportConnection': '接続をエクスポート',
  'connection.button.downloadTemplate': 'テンプレートをダウンロード',
  'connection.button.connect': '接続',
  'connection.button.remove': '接続を削除',
  'connection.message.importSuccess': '{1} 件の接続をインポートしました',
  'connection.message.importPartialSuccess': '{1} 件の接続をインポートし、{2} 件失敗しました',
  'connection.message.unsupportedImportFile': 'このファイル形式のインポートには未対応です',
  ...
  'connection.label.accessScope.personal': '個人',
  'connection.label.accessScope.project': 'プロジェクト共有',
  ...
  'connection.tips.importTemplate': 'Chat2DB テンプレート JSON をサポートし、.ncx / .dbp にも互換です。',
  'connection.placeholder.defaultEnvironment': 'テンプレート未一致時のデフォルト環境を選択',
  'connection.title.importTitle': 'ファイルをインポート, .json(Chat2DBテンプレート) / .ncx(navicat) / .dbp(dbever)',
};
