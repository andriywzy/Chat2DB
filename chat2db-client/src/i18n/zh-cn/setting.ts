export default {
  ...
  'setting.knowledge.tip': '知识库会将 PDF 解析后生成向量，并把元数据记录在本地。',
  'setting.knowledge.tip.description': '当前仅支持上传 PDF。删除记录只会移除本地元数据，不会清理远端向量存储。',
  'setting.knowledge.search.placeholder': '搜索知识库名称或文件名',
  'setting.knowledge.upload.namePlaceholder': '知识库名称，可选',
  'setting.knowledge.upload.select': '选择 PDF',
  'setting.knowledge.upload.submit': '上传知识库',
  'setting.knowledge.upload.selectFile': '请先选择 PDF 文件',
  ...
  'setting.knowledge.delete.description': '该操作只会删除本地元数据记录。',
