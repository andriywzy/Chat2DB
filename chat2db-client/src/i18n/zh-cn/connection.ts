export default {
  ...
  'connection.button.exportConnection': '导出连接',
  'connection.button.downloadTemplate': '下载模板',
  'connection.button.connect': '连接',
  'connection.button.remove': '删除链接',
  'connection.message.importSuccess': '成功导入 {1} 个连接',
  'connection.message.importPartialSuccess': '成功导入 {1} 个连接，失败 {2} 个',
  'connection.message.unsupportedImportFile': '暂不支持该导入文件类型',
  ...
  'connection.label.accessScope.personal': '个人',
  'connection.label.accessScope.project': '项目共享',
  ...
  'connection.tips.importTemplate': '支持导入 Chat2DB 模板 JSON，也兼容 .ncx / .dbp 文件。',
  'connection.placeholder.defaultEnvironment': '请选择默认环境（模板未命中时使用）',
  'connection.title.importTitle': '导入文件, .json(Chat2DB模板) / .ncx(navicat) / .dbp(dbever)',
};
